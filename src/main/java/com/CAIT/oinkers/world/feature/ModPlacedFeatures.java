...
public class ModPlacedFeatures {
	...
	public static final RegistryObject<PlacedFeature> ATIUM_ORE_PLACED = PLACED_FEATURES.register("atium_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.ATIUM_ORE.getHolder().get(),
