...
public class StoneCarrotBlock extends CropBlock {
	...
	public StoneCarrotBlock(BlockBehaviour.Properties p_51328_) {
	      super(p_51328_);
	 }

	@Override
	public boolean canSurvive(BlockState state, LevelReader level, BlockPos pos) {
		if ((level.getBlockState(pos.below()).is(Blocks.STONE)) || (level.getBlockState(pos.below()).is(BlockInit.CARROT_STONE.get()))) {
			return true;
		}
		return false;
	}
   ...
   protected ItemLike getBaseSeedId() {
      return ItemInit.STONE_CARROT.get();
   }
