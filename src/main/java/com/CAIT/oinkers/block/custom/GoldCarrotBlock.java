...
public class GoldCarrotBlock extends CropBlock {
	...
	public GoldCarrotBlock(BlockBehaviour.Properties p_51328_) {
	      super(p_51328_);
	 }

	@Override
	public boolean canSurvive(BlockState state, LevelReader level, BlockPos pos) {
		if (level.getBlockState(pos.below()).is(Blocks.GOLD_BLOCK)) {
			return true;
		}
		return false;
	}
   ...
   protected ItemLike getBaseSeedId() {
      return ItemInit.GOLD_CARROT.get();
   }
