...
public class IronCarrotBlock extends CropBlock {
	...
	public IronCarrotBlock(BlockBehaviour.Properties p_51328_) {
	      super(p_51328_);
	 }

	@Override
	public boolean canSurvive(BlockState state, LevelReader level, BlockPos pos) {
		if (level.getBlockState(pos.below()).is(Blocks.IRON_BLOCK)) {
			return true;
		}
		return false;
	}
   ...
   protected ItemLike getBaseSeedId() {
      return ItemInit.IRON_CARROT.get();
   }
