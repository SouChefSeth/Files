...
import com.CAIT.oinkers.item.CarrotSword;
...
public class ItemInit {
	...
	public static final RegistryObject<Item> STONE_CARROT = register("stone_carrot", 
			() -> new Item(new Item.Properties().tab(oinkers.TAB).food(new FoodProperties.Builder().nutrition(4).saturationMod(2.5f)
	...
	public static final RegistryObject<Item> IRON_CARROT = register("iron_carrot", 
			() -> new Item(new Item.Properties().tab(oinkers.TAB).food(new FoodProperties.Builder().nutrition(6).saturationMod(2.5f)
					.effect(() -> new MobEffectInstance(MobEffects.DAMAGE_BOOST, 600, 1), 1).alwaysEat().build())));
	
	public static final RegistryObject<Item> GOLD_CARROT = register("gold_carrot", () -> new Item(new Item.Properties()
			.tab(oinkers.TAB)
	...
	public static final RegistryObject<Item> DIAMOND_CARROT = register("diamond_carrot", () -> new Item(new Item.Properties()
			.tab(oinkers.TAB)
			.food(new FoodProperties.Builder()
					.nutrition(10)
					.saturationMod(2.5f)
	...
	public static final RegistryObject<Item> ATIUM_BLOCK = register("atium_block", () -> new Item(new Item.Properties().tab(oinkers.TAB)));
	
	/**
	 * Atium tools
	 */
	public static final RegistryObject<SwordItem> ATIUM_SWORD = register("atium_sword", 
			() -> new CarrotSword(ModTiers.ATIUM, 7, .5f, new Item.Properties().tab(oinkers.TAB)));	// first int attack dam, second is speed
	...
	public static final RegistryObject<SwordItem> CARROT_SWORD = register("carrot_sword", 
			() -> new CarrotSword(ModTiers.CARROT, 8, .5f, new Item.Properties().tab(oinkers.TAB)));	// first int attack dam, second is speed
