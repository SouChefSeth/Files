...
public class FlyingBoatItem extends Item {
    ...
    public FlyingBoatItem(Properties p_i48487_1_) {
        super(p_i48487_1_);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
           ...
           if (hitresult.getType() == HitResult.Type.BLOCK) {
              FlyingBoatEntity boat = new FlyingBoatEntity(
            		  p_40622_, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
