...
public enum ModArmorMaterials implements ArmorMaterial {
		   ...
		   CARROT("carrot", 33, new int[]{3, 6, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.0F, 
				   () -> Ingredient.of(ItemInit.CARROT_INGOT.get())),
		   ATIUM("atium", 33, new int[]{2, 6, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.5F, 0.0F, 
