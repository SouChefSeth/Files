...
public class CarrotForgeScreen extends AbstractContainerScreen<CarrotForgeMenu>{
	public static final ResourceLocation TEXTURE =
			new ResourceLocation(oinkers.MOD_ID, "textures/gui/carrot_forge_gui.png");

	public CarrotForgeScreen(CarrotForgeMenu menu, Inventory inv, Component component) {
