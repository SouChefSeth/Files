...
public class CarrotForgeMenu extends AbstractContainerMenu{
	
	public final CarrotForgeBlockEntity blockEntity;
	...
	public boolean stillValid(Player player) {
		return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, BlockInit.CARROT_FORGE.get());
	}
